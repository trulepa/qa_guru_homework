...
def empty_full_name(url, driver, locator, result_line_name):
    try:
        empty_test = TestSuite(url, driver)
        empty_test.set_up()
        empty_test.search_fill_fields(locator["full_name_locator"], "")
        empty_test.click_submit(locator["submit_button_locator"])
        result_box = empty_test.search_result_box(locator["result_box_locator"])
        current_line = empty_test.get_sring(result_box, result_line_name["full_name"])
...
empty_full_name(url, driver, locator, result_line_name)
